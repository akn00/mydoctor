...
const Index = () => {
    ...
    <TextField id="outlined-basic" label="Email or Mobile Number *" variant="outlined" margin="normal" value={email} onChange={(e)=>(setemail(e.target.value))}/>
    <TextField id="outlined-basic" type="password" label="Password *" variant="outlined" margin="normal" value={password} onChange={(e)=>(setPassword(e.target.value))}/>
    </div>
